...
test-symfony4-functional:
	docker-compose run --rm -u $(shell id -u) symfony4_sandbox composer test:functional

test-symfony5-functional:
	docker-compose run --rm -u $(shell id -u) symfony5_sandbox composer test:functional

test-symfony6-functional:
	docker-compose run --rm -u $(shell id -u) symfony6_sandbox composer test:functional
